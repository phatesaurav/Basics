...
public class CreateArrayListFromCollectionExample_5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(firstFivePrimeNumbers); // [2, 3, 5, 7, 11]

		List<Integer> firstTenPrimeNumbers = new ArrayList<>(firstFivePrimeNumbers);
		System.out.println(firstTenPrimeNumbers); // [2, 3, 5, 7, 11]
