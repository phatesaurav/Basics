...
public class AccessElementsFromArrayListExample_6 {

	public static void main(String[] args) {
		List<String> topProgrammingLanguages = new ArrayList<>();

		// Check if an ArrayList is empty
		System.out.println("Is the topProgrammingLanguages list empty? : " + topProgrammingLanguages.isEmpty()); // true
		...
		System.out.println("bestProgrammingLang => " + bestProgrammingLang); // Java

		String secondBestProgrammingLang = topProgrammingLanguages.get(3);
		System.out.println("secondBestProgrammingLang => " + secondBestProgrammingLang); // Python

		// Modify the element at a given index
		topProgrammingLanguages.set(4, "C#");
		System.out.println(topProgrammingLanguages); // [C, Java, C++, Python, C#]
